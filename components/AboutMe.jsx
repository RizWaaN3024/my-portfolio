...
const AboutMe = () => {
  ...
  return (
    <div className="container mx-auto about-section relative py-[40px] text-white">
      ...
      <div className="pt-[24px] text-[36px] text-left overflow-hidden">
        <p className=" about-desc overflow-hidden">
          Hey there!!👋 I'm Rizwaan, your friendly neighbourhood Full-Stack
          Developer,
        </p>
        <p className="about-desc overflow-hidden">
          coding my way through the web like Spider-Man swings through the
          city.🕸️
        </p>
      </div>
      ...
      <div className=" pt-[44px] overflow-hidden">
        <h3 className="text-[42px] font-bold text-center border-b-2 border-white about-title2">
          The Short Story
        </h3>
        ...
        <p className="text-[36px] text-center overflow-hidden about-desc2">
          back-end systems. By night, I'm...well, still a coder. But with more
          snacks and bad puns.
        </p>
      </div>
      <div className=" pt-[44px] overflow-hidden pb-[40px]">
        <h3 className="text-[42px] font-bold text-center border-b-2 border-white about-title3">
          The Origin Story
        </h3>
